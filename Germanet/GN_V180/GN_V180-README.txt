GermaNet Version 18.0
=====================
Release date: May 2023


=====================================
Significant Changes Compared to Version 17.0
=====================================
...
167163		Synsets
215000		Lexical units
199692		Literals
1.29		Lexical units per synset
181530		Conceptual relations
12602		Lexical relations (synonymy excluded)
121655		Split compounds
...
GermaNet 18.0 is provided both in an XML format and as a PostgreSQL database dump.

The GermaNet XML data can be found in the folder "GN_V180_XML", and contains the
following files:
54 GermaNet object files + 1 DTD format description file
1 GermaNet relations file + 1 DTD format description file
3 placeholder files for Wiktionary mappings + 1 DTD format description file
1 placeholder file for Interlingual Index (ILI) mappings + 1 DTD format description file

The GermaNet database dump can be found in the folder "GN_V180_DB" along with
instructions on how to set up the database.

======================
External Data Mappings
======================

* Mappings between Wiktionary sense descriptions and GermaNet’s lexical units are available for download on the GermaNet homepage.

Please note that license conditions for Wiktionary differ from license conditions for GermaNet.

The Wiktionary sense descriptions are subject to the Creative Commons Attribution/Share-Alike License (CC BY-SA 3.0) (http://creativecommons.org/licenses/by-sa/3.0/).

* The Interlingual Index (ILI) maps GermaNet senses to their corresponding entries in Princeton WordNet®. These mappings are also available for download on the GermaNet homepage.

Please note that license conditions for Princeton WordNet(R) differ from license conditions for GermaNet.

License information for the Princeton WordNet(R) data can be found at https://wordnet.princeton.edu/license-and-commercial-use

More information about using the Wiktionary and ILI data can be found in the "Downloads" section of the homepage.


=================================
Associated Applications and Tools
=================================

* Java and Python APIs:
	provide easy access to all information in GermaNet, with search filtering, and methods for calculating the semantic relatedness of two synsets.

*  GermaNet Rover (https://weblicht.sfs.uni-tuebingen.de/rover/):
	A web application for exploring GermaNet, including search, semantic relatedness, and visualization. Single sign-on is used, which means that you can log in through your academic institution.

See the "Applications and Tools" section of the homepage for more information.

Some of the older tools **might** still work, but are no longer actively maintained:
...
There is further information about GermaNet at: https://uni-tuebingen.de/en/142806
Please address questions and comments to: germanetinfo@sfs.uni-tuebingen.de

=======
License
=======

GermaNet version 18.0 is distributed to academic institutions on the basis of the GERMANET DATA ACADEMIC RESEARCH LICENSE AGREEMENT.

The LICENSEE is the academic department that has made this data available to you. If you are in doubt whether your academic department has signed a GermaNet license, please contact the director or head of your department or send an email to germanetinfo@sfs.uni-tuebingen.de.
...
Email germanetinfo@sfs.uni-tuebingen.de
represented by Prof. Dr. Erhard W. Hinrichs, Director 


The license conditions of the GERMANET DATA ACADEMIC RESEARCH LICENSE AGREEMENT are as follows:
...
12.	GERMANET DATA are provided to LICENSEE "as is", without any warranty and without any guarantee of its usability. LICENSOR excludes all liability of whatsoever nature for direct, consequential or indirect loss or damage suffered by the LICENSEE in connection with the distribution of GERMANET DATA. LICENSOR MAKES NO REPRESENTATIONS OR WARRANTIES OF MERCHANTABILITY OR FITNESS FOR ANY PARTICULAR PURPOSE OR THAT THE USE OF THE LICENSED SOFTWARE, DATABASE OR DOCUMENTATION WILL NOT INFRINGE ANY THIRD PARTY PATENTS, COPYRIGHTS, TRADEMARKS OR OTHER RIGHTS.  
	...
	DISTRIBUTION
13.	The most recent release of the GERMANET DATA will be distributed within thirty (30) days after the effective date as an archive attached to an email or any other medium the partners agree upon. LICENSEE may be offered updates of the GERMANET DATA if a new data release becomes available. Such updates will be subject to the terms of this Agreement.
...
Reinhild Barkey, Anna-Sophie Bartle, Agnia Barsukova, Valérie Béchet-Tsarnos, Anne Brock, Ben Campbell, Julia Chant, Alexandr Chernov, Edo Collins, Bettina Demmer, Valentin Deyringer, Helmut Feldweg, Patricia Fischer, Clemens Frey, Sabrina Galasso, Piklu Gupta, Annabell Grasse, Luca Haeselbarth, Marina Haid, Birgit Hamp,  Alexander Hartmann, Tanja Heck, Verena Henrich, Marie Hinrichs, Michael Hipp, Christina Hoppermann, Lars Horber, Julia Koch, Lea Krumbach, Silke Kugler, Claudia Kunze, Anja Laske, Richard Lawrence, Alina Leippert, Lothar Lemnitzer, Andrea Lorenz, Karin Naumann, Annika Ott, Till Pachalli, Katrin Petodnig, Victoria Pierz, Wei Qiu, Daniela Rossmann, Eyal Schejter, Niko Schenk, Susanne Schüle, Sarah Schulz, Lisa Seneberg, Daniil Sorokin, Rosemary Stegmann, Daniela Stelle, Daniela Stier, Tabea Stier, Yana Strakatova, Steffen Tacke, Christine Thielen, Lukas Emilio Tortora, Tatiana Vodolazova, Andreas Wagner, Johannes Wahle, Zarah-Leonie Weiss, Neele Witte, Martin Wolf and Holger Wunsch.
...
Citation instructions and GermaNet publications can be found at:
citation: https://uni-tuebingen.de/en/142823
publications: https://uni-tuebingen.de/en/142836
